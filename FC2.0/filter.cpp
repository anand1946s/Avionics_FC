...
// KF tuning
static float Q00 = 0.10f;   // altitude process noise(increase alti changes faster)
static float Q11 = 40.0f;    // velocity process noise(increase trust imu less)
static float R   = 9.0f;    // how unreliable baro is(increase trust baro less)
